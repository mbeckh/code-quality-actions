...
[![CI/Tests](https://img.shields.io/github/actions/workflow/status/mbeckh/code-quality-actions/ci.yml?branch=master&label=CI/Tests&logo=GitHub&style=flat-square)](https://github.com/mbeckh/code-quality-actions/actions)
